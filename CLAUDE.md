...
| `thesis/chapters/06_resultados.tex` | Cap 6: Resultados Experimentales | Completo (§6.1 Recomendacion, §6.2 Costo Computacional, §6.3 Plan de Pruebas). Los resultados de clustering (Hopkins, Silhouette, UMAP, NMI) se presentan en §5.6 (Solucion Propuesta), no en este capitulo. La seccion Discusion se elimino el 2026-06-18 (ver nota abajo) |

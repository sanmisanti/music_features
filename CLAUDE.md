...
- [x] Redaccion LaTeX completa — 6 capitulos (Introduccion, Estado de la Cuestion, Definicion del Problema, Marco Teorico, Solucion Propuesta, Conclusiones). §4 Marco Teorico (§4.1, §4.2, §4.4, §4.5 con 8 subsecciones, §4.6); §5.7 Sistema de Recomendacion con sus resultados; §1 Introduccion ampliada. El Cap Resultados se elimino el 2026-07-05: los resultados de recomendacion se reubicaron a §5.7 y las secciones Costo/Plan de Pruebas se descartaron. Los 3 anexos (A-C) se eliminaron el 2026-06-14 (ver tabla ESTRUCTURA DEL INFORME)
...
| ~~`thesis/chapters/06_resultados.tex`~~ | (Cap Resultados) | **ELIMINADO del informe (2026-07-05)**. Los resultados de recomendacion se reubicaron a §5.7 (ver nota "Resultados de recomendacion reubicados" abajo); las secciones Costo Computacional y Plan de Pruebas se descartaron. El `\input` se quito de `main.tex`; el archivo quedo huerfano (pendiente de borrar con `git rm`). El detalle de tiempos permanece en `results/metrics/` y el plan en `src/recommendation/PRUEBAS_CALIDAD.md` |
| `thesis/chapters/07_conclusiones.tex` | Cap 6 en el PDF (Conclusiones y Futuras Lineas) | Completo (§7.1-§7.4 en el codigo; renumerado a Cap 6 / §6.1-§6.4 en el PDF tras eliminar Resultados; el nombre de archivo conserva el `07_`). Las `\ref` se ajustan solas; no hay numeros de capitulo escritos a mano en la prosa |

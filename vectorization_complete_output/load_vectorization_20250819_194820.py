#!/usr/bin/env python3
"""
Script de carga rápida - Vectorización Completa 20250819_194820
...
def load_complete_vectorization():
    ...
    # Cargar componentes
    embeddings = np.load(base_dir / "embeddings_complete_20250819_194820.npy")
    track_ids = np.load(base_dir / "track_ids_complete_20250819_194820.npy")
    
    with open(base_dir / "similarity_index_20250819_194820.pkl", 'rb') as f:
